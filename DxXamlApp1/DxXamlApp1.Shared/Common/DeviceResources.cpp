...
void DX::DeviceResources::CreateWindowSizeDependentResources() 
{
	...
	// 必要なスワップ チェーンとレンダリング ターゲットのサイズをピクセル単位で計算します。
	...
	else
	{
		...
		// UI の変更は、UI スレッドにディスパッチし戻す必要があります
...
// アプリが停止したときに、このメソッドを呼び出します。アプリがアイドル状態になり、
// 一時バッファーが他のアプリで使用するために解放できることを、ドライバーにヒントを提供します。
