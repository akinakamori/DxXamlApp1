...
DxXamlApp1Main::DxXamlApp1Main(const std::shared_ptr<DX::DeviceResources>& deviceResources) :
...
void DxXamlApp1Main::CreateWindowSizeDependentResources() 
{
...
void DxXamlApp1Main::ProcessInput()
{
